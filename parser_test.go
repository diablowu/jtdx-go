...
func TestParseMessage(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want: parseResult{StatusMessage{
				Id:                   "WSJT-X",
		...
		{
			name: "Parse Status 2.3.1",
			args: argsFrom(`adbccbda00000002000000010000000657534a542d5800000000006bf0d000000003465438ffffffff000000032d313500000003465438000000000003730000079e000000054b3053574500000006444d37394c56ffffffff00ffffffff0000ffffffffffffffff0000000744656661756c7400000000`),
			want: parseResult{StatusMessage{
				Id:                   "WSJT-X",
				DialFrequency:        7074000,
				Mode:                 "FT8",
		...
		},
		{
			...
			want: parseResult{DecodeMessage{
				Id:               "WSJT-X",
				New:              true,
				Time:             39435000,
				Snr:              -5,
		...
		},
		{
			...
			want: parseResult{WSPRDecodeMessage{
				Id:        "WSJT-X",
				New:       true,
				Time:      45480000,
				Snr:       -18,
		...
		},
		{
			...
			want: parseResult{LoggedAdifMessage{
				Id: "WSJT-X",
				Adif: `
<adif_ver:5>3.1.0
<programid:6>WSJT-X
